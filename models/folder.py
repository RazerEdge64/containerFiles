...
class Folder(AccessControlledModel):
    ...
    def initialize(self):
        ...
        self.exposeFields(level=AccessType.READ, fields=(
            ...
            'size', 'meta', 'parentId', 'parentCollection','assign', 'creatorId',
    ...
    def setAssignments(self, folder, metadata, allowNull=False):
        """
        
        """
        if 'assign' not in folder:
            folder['assign'] = {}

        # Add new metadata to existing metadata
        folder['assign'].update(metadata.items())

        #Adding code for time updation.
        folder['assign']['updated_time']=datetime.datetime.utcnow()
        ...
        self.validateKeys(folder['assign'])
    ...
    def createFolder(self, parent, name, description='', parentType='folder',
                     public=None, creator=None, assign='', allowRename=False, reuseExisting=False):
        """
    ...
    def copyFolder(self, srcFolder, parent=None, name=None, description=None,
        ...
        newFolder = self.createFolder(
            parentType=parentType, assign=assign, parent=parent, name=name,
