...
class Folder(Resource):
    ...
    def __init__(self):
        ...
        self.route('POST', (':id', ), self.updateFolder)
    ...
    @autoDescribeRoute(
        ...
        .param('assign', "This is for assigning a case to users", default='abc', required=False
        )
    ...
    def updateFolder(self, folder, assign, name, description, parentType, parentId, metadata):
        user = self.getCurrentUser()
        if name is not None:
            folder['name'] = name
    ...
    @autoDescribeRoute(
        ...
        .param('assign', "This is for assigning a case to users", default="", required=False, paramType='formData'
        )
    ...
    def createFolder(self, public, parentType, parentId, name, description,
        ...
        newFolder = self._model.createFolder(
            ...
            description=description, assign=assign, public=public, reuseExisting=reuseExisting)
        if metadata:
