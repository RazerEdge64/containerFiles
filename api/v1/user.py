...
class User(Resource):
    ...
    @autoDescribeRoute(
        ...
        .responseClass('User')
        .param('login', "The user's requested login please.", paramType='formData')
        .param('email', "The user's email address.", paramType='formData')
        .param('mobileNumber', "The user's mobile number", paramType='formData')
        ...
        .param('role', "The is a CADSC user's role.", default="guest", required=True, paramType='formData',
        dataType='string')
    ...
    def createUser(self, login, email, mobileNumber, firstName, lastName, role , password, admin):
        ...
        user = self._model.createUser(
            login=login, password=password, email=email, mobileNumber=mobileNumber, firstName=firstName,
            lastName=lastName, role=role ,admin=admin)
    ...
    @autoDescribeRoute(
        ...
        .param('role', "The IS A CADSC USER's role.",dataType='array')
